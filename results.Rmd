...
```{r easy-draw-dog2, fig.cap="Dog 2 – top-5 detections (note: degenerate boxes filtered; model requires torch ≥ 0.17 for correct output)"}
...
generated `man/draw_keypoints.Rd`, with a `NEWS.md` entry.

**Pull request**: [mlverse/torchvision#296](https://github.com/mlverse/torchvision/pull/296)
